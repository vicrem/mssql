...
DECLARE @BackupDirectory nvarchar(max)     = '/var/opt/mssql/backup'        -- Specify the backup root directory. If no directory is specified, the default backup directory is used.
